...
namespace Assignment2.Controllers
{
    public class MajorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MajorID,MajorName,NumberOfProfs,MajorCapacity,OfficeLocation")] Major major)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MajorID,MajorName,NumberOfProfs,MajorCapacity,OfficeLocation")] Major major)
        {
            if (id != major.MajorID)
            {
                return NotFound();
